...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-dark" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <EnvelopeIcon className="hidden h-16 w-16 text-light md:block" />
          <h2 className="text-2xl font-bold text-light">{headerText}</h2>
        </div>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-300 hover:text-highlight focus:outline-none focus:ring-2 focus:ring-highlight',
                          {'hover:text-highlight': href},
                        )}
                        href={href}
                        target="_blank">
